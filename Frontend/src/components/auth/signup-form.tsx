      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2">
            ...
            <h1 className="text-xl font-bold">Chào mừng bạn đến với <span className="bg-gradient-to-r from-[#00B4DB] to-[#6a11cb] bg-clip-text text-transparent font-extrabold">Chat Nexa</span></h1>
          </div>
          <div className="flex flex-col gap-6">
